    ...
    return (
        <div className="car-card group cursor-pointer">
            ...
            <div className="relative w-full h-40 my-3 object-contain">
                <Image src={ fetchCarIamges( car ) } alt="car" fill priority className="object-contain"/>
            </div>
            <div className="relative flex w-full mt-2">
                ...
                <div className="car-card__btn-container">
                    <CustomButton 
                        title="View More" 
                        containerStyles=" w-full bg-blue-600 hover:bg-blue-700 text-white rounded-full mt-10 transition duration-300 ease-in-out" 
